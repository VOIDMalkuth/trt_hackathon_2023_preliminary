...
def build_controlnet_trt_engine():
    ONNX_WEIGHT_DIR = "onnx_models/fused_model/"
    ONNX_FILE_PATH = "fused_model_static_shape.onnx"
    TRT_ENGINE_PATH = "trt_fused_model.plan"
    ...
    print("Succeeded building and serializing trt engine for fused_model!")
