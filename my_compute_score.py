...
for i in range(20):
    ...
    base_path = "./torch_baseline_imgs/bird_"+ str(i) + ".jpg"
    img = cv2.imread(path)
...
print("Score max:", max(scores), ", average:", sum(scores)/len(scores))
print("Latency average:", sum(latencys)/len(latencys))
